    ...
    <SectionBorder borderTop>
      <SectionContent className="relative isolate">
        ...
        <h2 className="text-gray-200 font-semibold text-3xl md:text-4xl lg:text-5xl max-w-3xl mx-auto text-center leading-tight">
          Join the AI Evolution with{" "}
          <span className="relative isolate">
              <span>HAI7</span>
              <span className="absolute top-full left-0 w-full -translate-y-1/2 h-4 bg-gradient-to-r from-purple-500 via-blue-500 to-indigo-500"
                style={{
              ...
              ></span>
          </span> with Revolutionary Ideas !
        </h2>
        <p className="text-center text-xl mt-8 max-w-2xl mx-auto">
          Experience the transformative power of AI with HAI7. Elevate your productivity, streamline your workflow, and unlock new possibilities with our cutting-edge AI Chat Cross Platform. Join us and be a part of the future today!
        </p>
