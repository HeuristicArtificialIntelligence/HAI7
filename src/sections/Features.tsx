        ...
        <SectionBorder borderTop>
          <SectionContent className="md:px-20 lg:px-40">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
              <div>
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold text-gray-200 leading-tight">Unlock Seamless Collaboration with AI</h2>
                <p className="mt-4 text-lg text-gray-300 md:text-xl lg:text-xl">Experience the future of teamwork with intelligent tools designed to enhance productivity and streamline your workflow.</p>
              ...
              <div className="size-[270px] md:size-[450px] relative flex-shrink-0">
                ...
                {logos.map(({ src, alt, rotate })=>(
                    ...
                    key={alt}
                    >
                    <motion.div className="inline-flex size-10 md:size-14 items-center justify-center border border-[var(--color-border)] rounded-lg absolute left-0 top-1/2 -translate-x-1/2 -translate-y-1/2 -rotate-0 bg-gray-950"
                      initial={{
                        translate: "-50% -50%",
                        rotate: -rotate,
                      }}
